...
namespace MazikCare.MobEval.Views
{
    ...
    /// </summary>
    public sealed partial class Symptoms : MazikCare.MobEval.Common.LayoutAwarePage
    {
        public Symptoms()
        {
        ...
        private void Done_Click(object sender, RoutedEventArgs e)
        {
            ...
            foreach (string str in this.gvSymptoms.SelectedItems)
            {
                list.Add(str);
            }

            ((DiagnosisData)this.DefaultViewModel["DiagnosisData"]).Symptoms = list;
