...
namespace MazikCare.MobEval
{
    ...
    public sealed partial class PatientList : MazikCare.MobEval.Common.LayoutAwarePage
    {
        ...
        private ObservableCollection<Patient> GetDefaultPatients()
        {
            ...
            patientList.Add(new Patient() { Name = "Bruce Caine", PhoneNumber = "989898343", RoomNumber = "101", ImagePath = "Assets/profile2.png", PatientDiagnosis1 = "Type 1 Diabetes Mellitus 250.01,", PatientDiagnosis2 = "HTN 401.09,", PatientDiagnosis3 = "Asthma", Prescription1 = "Oxygen holder", Prescription2 = "OmniPod Insulin Pump" });
